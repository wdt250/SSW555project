		...
		public static boolean UniqueNameAndBirthDate(ArrayList<Individual> individuals, PrintWriter outfile) {
			...
			for(Individual individual: individuals) {
				if(names.containsKey(individual.getName()) && names.get(individual.getName()).equals(individual.getBirthDate())){
					flag = false;
					System.out.println("Error:Individual:(" + individual.getIndividualId() + "): Cannot have duplicate name and birthdate!");
					outfile.println("Error:Individual:(" + individual.getIndividualId() + "): Cannot have duplicate name and birthdate!");
				}
